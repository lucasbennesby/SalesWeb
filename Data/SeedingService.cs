...
namespace SalesWeb.Data
{
    ...
    {
        private SalesWebContext _context { get; set; }
        ...
        public void Seed()
        {
            ...
            Department d3 = new Department(3, "Clothing");
            Department d4 = new Department(4, "Books");
            Department d5 = new Department(5, "Detran");

            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Ana Taylor", "ana@gmail.com", new DateTime(2000, 9, 22), 1500.0, d2);
            Seller s3 = new Seller(3, "Jhon Krew", "krew@gmail.com", new DateTime(1973, 1, 12), 3200.0, d3);
            Seller s4 = new Seller(4, "Lidia Gray", "lidia@gmail.com", new DateTime(1999, 6, 13), 2000.0, d3);
            Seller s5 = new Seller(5, "Alex Green", "alex@gmail.com", new DateTime(1968, 6, 26), 1800.0, d4);
            Seller s6 = new Seller(6, "Maria Clara", "maria@gmail.com", new DateTime(2002, 9, 8), 1600.0, d5);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 09, 25), 1000.0, SaleStatus.Billed, s1);
            SalesRecord r2 = new SalesRecord(2, new DateTime(2018, 09, 23), 1000.0, SaleStatus.Billed, s2);
            SalesRecord r3 = new SalesRecord(3, new DateTime(2018, 08, 13), 100.90, SaleStatus.Billed, s3);
            SalesRecord r4 = new SalesRecord(4, new DateTime(2018, 09, 10), 275.80, SaleStatus.Billed, s4);
            SalesRecord r5 = new SalesRecord(5, new DateTime(2018, 09, 05), 368.68, SaleStatus.Billed, s5);
            SalesRecord r6 = new SalesRecord(6, new DateTime(2018, 09, 13), 2478.67, SaleStatus.Billed, s6);
